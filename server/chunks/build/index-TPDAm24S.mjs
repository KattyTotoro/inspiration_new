...
import { b as useFetch, a as __nuxt_component_0 } from './server.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/post/by_rubrics/4", "$G51qW1wV1t")), __temp = await __temp, __restore(), __temp);
    const posts = ref((_a = data.value) == null ? void 0 : _a.posts);
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      const _component_NuxtImg = _sfc_main$1;
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "content" }, _attrs))}><h1><strong>\u0420\u0435\u0446\u0435\u043F\u0442\u044B. \u0416\u0438\u0432\u043E\u0435 \u043F\u0438\u0442\u0430\u043D\u0438\u0435.</strong></h1>`);
      if (!((_a2 = unref(posts)) == null ? void 0 : _a2.length)) {
        _push(`<p>\u041F\u0443\u0431\u043B\u0438\u043A\u0430\u0446\u0438\u0439 \u043F\u043E\u043A\u0430 \u043D\u0435\u0442</p>`);
      } else {
        _push(`<div class="blockList"><!--[-->`);
        ssrRenderList(unref(posts), (post) => {
          _push(`<div class="post">`);
          ...
          _push(`</h2><p>${ssrInterpolate(post.preview)}</p></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</section>`);
...
//# sourceMappingURL=index-TPDAm24S.mjs.map
