import { defineComponent, shallowRef, h, ref, getCurrentInstance, watchEffect, nextTick, unref } from 'vue';
import { Plugin, PluginKey, Selection, TextSelection, NodeSelection } from '@tiptap/pm/state';
import { Fragment, Slice, Node as Node$1, Schema, DOMParser } from '@tiptap/pm/model';
import { findWrapping, canJoin, canSplit, joinPoint, liftTarget, ReplaceStep, ReplaceAroundStep } from '@tiptap/pm/transform';
...
//# sourceMappingURL=index-DkmfnpzE.mjs.map
