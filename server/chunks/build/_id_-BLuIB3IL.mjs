...
import { h as useApp, d as useRoute, b as useFetch, a as __nuxt_component_0 } from './server.mjs';
...
import { ssrRenderAttrs, ssrRenderAttr, ssrRenderList, ssrInterpolate, ssrRenderClass, ssrIncludeBooleanAttr, ssrRenderComponent } from 'vue/server-renderer';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/post/${id}`, "$b1kuJYDcbE")), __temp = await __temp, __restore(), __temp);
    const post = ref((_a = data.value) == null ? void 0 : _a.post);
    const editor = useEditor({
      content: (_b = post.value) == null ? void 0 : _b.text
    });
    return (_ctx, _push, _parent, _attrs) => {
      const _component_TiptapEditorContent = EditorContent;
      const _component_NuxtLink = __nuxt_component_0;
      if (post.value) {
        _push(`<section${ssrRenderAttrs(mergeProps({ class: "content tt" }, _attrs))}><input class="myEditor" type="text"${ssrRenderAttr("value", post.value.title)}>`);
        if (!post.value.approved) {
          _push(`<!--[--><label class="label_rubric_create" for="rubric">\u0412\u044B\u0431\u043E\u0440 \u0440\u0443\u0431\u0440\u0438\u043A\u0438: </label><select class="rubric_create" name="rubric" id="rubric"><!--[-->`);
        ...
        _push(`<div class="tiptapImg"><form method="post"><input type="text" name="alt"${ssrRenderAttr("value", alt.value)} placeholder="\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u043A\u0430\u0440\u0442\u0438\u043D\u043A\u0438"><input type="file" placeholder="\u0418\u0437\u043E\u0431\u0440\u0430\u0436\u0435\u043D\u0438\u0435"><input class="uploadPicBut" type="submit" value="\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C"></form></div><button>\u0421\u043E\u0445\u0440\u0430\u043D\u0438\u0442\u044C \u043F\u043E\u0441\u0442</button>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: `/posts/${post.value.id}_${post.value.title_en}`
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`${ssrInterpolate(post.value.title)}`);
            } else {
              return [
                createTextVNode(toDisplayString(post.value.title), 1)
              ];
            }
          }),
          _: 1
        }, _parent));
        _push(`<button class="deletPostButtom">\u0423\u0434\u0430\u043B\u0438\u0442\u044C \u043F\u043E\u0441\u0442</button></section>`);
      } else {
        _push(`<!---->`);
      }
    };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/lk/post_edit/[id].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_-BLuIB3IL.mjs.map
