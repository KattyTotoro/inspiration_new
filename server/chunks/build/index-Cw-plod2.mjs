...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/post", "$fi3CX8Fcds")), __temp = await __temp, __restore(), __temp);
    const posts = ref((_a = data.value) == null ? void 0 : _a.posts);
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      const _component_NuxtImg = _sfc_main$1;
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "content" }, _attrs))} data-v-ce4802b8><h1 data-v-ce4802b8>\u0412\u0441\u0435 \u043F\u0443\u0431\u043B\u0438\u043A\u0430\u0446\u0438\u0438</h1><div data-v-ce4802b8>`);
      if (!((_a2 = unref(posts)) == null ? void 0 : _a2.length)) {
        _push(`<p data-v-ce4802b8>\u041F\u0443\u0431\u043B\u0438\u043A\u0430\u0446\u0438\u0439 \u043F\u043E\u043A\u0430 \u043D\u0435\u0442</p>`);
      } else {
        _push(`<div class="blockList" data-v-ce4802b8><!--[-->`);
        ssrRenderList(unref(posts), (post) => {
          _push(`<div class="post" data-v-ce4802b8>`);
          _push(ssrRenderComponent(_component_NuxtImg, {
            src: `${post.img}`,
            sizes: "300px"
          }, null, _parent));
          _push(`<h2 data-v-ce4802b8>`);
          ...
          _push(`</h2><p data-v-ce4802b8>${ssrInterpolate(post.preview)}</p></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div></section>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ce4802b8"]]);

export { index as default };
//# sourceMappingURL=index-Cw-plod2.mjs.map
