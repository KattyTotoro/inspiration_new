...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch(`/api/post/${id}`, "$VqRYVBp8S-")), __temp = await __temp, __restore(), __temp);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(post)) {
        _push(`<div class="postPage"><h1>${ssrInterpolate((_a2 = unref(post)) == null ? void 0 : _a2.title)}</h1><br><div>${(_a3 = (_b2 = unref(post)) == null ? void 0 : _b2.text) != null ? _a3 : ""}</div><div style="${ssrRenderStyle({ "clear": "both" })}"></div><p class="authorPost">\u0410\u0432\u0442\u043E\u0440 \u043F\u043E\u0441\u0442\u0430: ${ssrInterpolate(unref(post).author.name ? unref(post).author.name : "\u0410\u0432\u0442\u043E\u0440 \u043D\u0435 \u0438\u0437\u0432\u0435\u0441\u0442\u0435\u043D")}</p><hr>`);
      ...
      if (!((_c = unref(posts)) == null ? void 0 : _c.length)) {
        ...
        ssrRenderList(unref(posts), (post2) => {
          ...
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/posts/${post2.id}_${post2.title_en}`
          }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/articles/[id_title].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=_id_title_-Cmyq0VY5.mjs.map
