...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    const { data } = ([__temp, __restore] = withAsyncContext(() => useFetch("/api/post", "$4KocRG7i-1")), __temp = await __temp, __restore(), __temp);
    const posts = ref((_a = data.value) == null ? void 0 : _a.posts);
    return (_ctx, _push, _parent, _attrs) => {
      var _a2;
      const _component_NuxtImg = _sfc_main$1;
      const _component_NuxtLink = __nuxt_component_0;
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "content" }, _attrs))} data-v-bad7dc7b><h1 data-v-bad7dc7b>\u0412\u0441\u0435 \u0441\u0442\u0430\u0442\u044C\u0438. <br data-v-bad7dc7b> \u0421\u0430\u0439\u0442 \u0412\u0434\u043E\u0445\u043D\u043E\u0432\u0435\u043D\u0438\u0435. \u0422\u0440\u0430\u043D\u0441\u043B\u0438\u0440\u043E\u0432\u0430\u043D\u0438\u0435 \u0437\u043D\u0430\u043D\u0438\u0439.<br data-v-bad7dc7b><strong data-v-bad7dc7b>\u041F\u0443\u0442\u0435\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u0438 \u0441\u0440\u0435\u0434\u0438 \u0437\u043D\u0430\u043D\u0438\u0439.</strong></h1><div data-v-bad7dc7b>`);
      if (!((_a2 = unref(posts)) == null ? void 0 : _a2.length)) {
        _push(`<p data-v-bad7dc7b>\u041F\u0443\u0431\u043B\u0438\u043A\u0430\u0446\u0438\u0439 \u043F\u043E\u043A\u0430 \u043D\u0435\u0442</p>`);
      } else {
        _push(`<div class="blockList" data-v-bad7dc7b><!--[-->`);
        ssrRenderList(unref(posts), (post) => {
          _push(`<div class="post" data-v-bad7dc7b>`);
          _push(ssrRenderComponent(_component_NuxtImg, {
            src: `${post.img}`,
            sizes: "300px"
          }, null, _parent));
          _push(`<h2 data-v-bad7dc7b>`);
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: `/posts/${post.id}_${post.title_en}`
          }, {
          ...
          _push(`</h2><p data-v-bad7dc7b>${ssrInterpolate(post.preview)}</p></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</div></section>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bad7dc7b"]]);

export { index as default };
//# sourceMappingURL=index-BFOthX_Y.mjs.map
